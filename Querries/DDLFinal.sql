...
-- Remover restrições de chaves estrangeiras
IF OBJECT_ID('dbo.fact_venda', 'U') IS NOT NULL BEGIN
    ALTER TABLE dbo.fact_venda DROP CONSTRAINT IF EXISTS dim_tempo_fact_venda_fk;
    ALTER TABLE dbo.fact_venda DROP CONSTRAINT IF EXISTS dim_produto_fact_venda_fk;
    ALTER TABLE dbo.fact_venda DROP CONSTRAINT IF EXISTS dim_cliente_fact_venda_fk;
    ALTER TABLE dbo.fact_venda DROP CONSTRAINT IF EXISTS dim_empresa_fact_venda_fk;
END;

IF OBJECT_ID('dbo.dim_produto', 'U') IS NOT NULL BEGIN
    ALTER TABLE dbo.dim_produto DROP CONSTRAINT IF EXISTS dim_departamento_dim_produto_fk;
    ALTER TABLE dbo.dim_produto DROP CONSTRAINT IF EXISTS dim_fornecedor_dim_produto_fk;
END;

-- Dropar tabelas
IF OBJECT_ID('dbo.fact_venda', 'U') IS NOT NULL DROP TABLE dbo.fact_venda;
...
IF OBJECT_ID('dbo.dim_fornecedor', 'U') IS NOT NULL DROP TABLE dbo.dim_fornecedor;
...
-- Recriar as tabelas com auto incremento
